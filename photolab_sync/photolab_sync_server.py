...
from photolab_sync.photolab_hash_collector import PhotolabHashCollector
...
class PhotolabSyncServer:
    def __init__(self, photolab_root: str, host: str = "127.0.0.1", port: int = 8080):
        ...
        class JSONRequestHandler(BaseHTTPRequestHandler):
            ...
            def do_GET(self):
                ...
                if self.path == "/api/collect_hashes":
                    ...
                    # Collect the data
                    phc = PhotolabHashCollector(photolab_root)
                    phc.collect()
...
if __name__ == "__main__":
    ...
    server = PhotolabSyncServer(photolab_root=args.photolab_root, host=args.host, port=int(args.port))
    server.run()
